...
const CONTRACT_ABI = [ // define the callable functions
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum SecureNotes.IconType",
        "name": "iconType",
        "type": "uint8"
      },
      {
    ...
    "outputs": [
      {
        ...
        "internalType": "struct SecureNotes.Note",
        "name": "",
        "type": "tuple"
      }
    ],
